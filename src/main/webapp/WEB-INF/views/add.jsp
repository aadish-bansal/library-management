<%@ page isELIgnored="false" %> <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
  ...
  <body class="container-fluid d-flex flex-column min-vh-100">
   ...
   if(session.getAttribute("loginData")==null){
    ...
    <section class="contatiner row mt-5">
      <div class="row">
        <h3 class="col-7 text-end">Add Book Details</h3>
      </div>
      <form:form action="validate-add-books" cssClass="row" modelAttribute="book" method="post">
        <div class="row mb-3">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-6">
            ...
            <!--<form:input path="authorNameOptions" cssClass="form-control" />-->
          </div>
